    ...
    <>
          ...
          <div className={styles.onBoardContent}>
            <div className={styles.onBoardHeader}>
              ...
              <h1 className={styles.textRootH1}>
                Фильмы и сериалы по подписке Плюс Мульти
              </h1>
              <h2 className={styles.textRootH2}>Бесплатно до конца года</h2>
              <p className={styles.textRootP}>
                Отменяйте в любой момент, напишем за 3 дня до первого списания
              </p>
            </div>
          </div>
          <div className={styles.buttonWrap}>
            <Button variant="main">Попробовать бесплатно до конца года</Button>
          </div>
          ...
          <div className={styles.yaPlusLeft}>
            <div className={styles.yaPlusMusic}>
              ...
              <p className={styles.yaPlusMusicText}>
                Слушайте музыку на разных устройствах и скачивайте в дорогу в
                высоком качестве.
              </p>
            </div>
            <div className={styles.yaPlusWrap}>
              <div className={styles.yaPlusGo}>
                ...
                <h3 className={styles.yaPlusLogoHeader}>
                  10% кешбэка баллами с поездок
                </h3>
                <p className={styles.yaPlusLogoText}>
                  в классе «Комфорт», «Комфорт+» и Ultima в приложении
                </p>
              </div>
              <div className={styles.yaPlusDrive}>
                ...
                <h3 className={styles.yaPlusLogoHeader}>
                  10% кешбэка баллами на каршеринг
                </h3>
                <p className={styles.yaPlusLogoText}>
                  за поездки по тарифу «Фикс»
                </p>
              </div>
            </div>
            <div className={styles.yaPlusMarket}>
              ...
              <p className={styles.yaPlusLogoText}>
                за покупку товаров со специальной отметкой
              </p>
            </div>
          </div>
      ...
      <div className={styles.onBoardingDevices}>
        <div className={styles.sectionHeader}>
          ...
          <p className={styles.textRootDevices}>
            Начните на телевизоре и продолжите с того же места на смартфоне или
            планшете.
          </p>
        </div>
        <div className={styles.onBoardingDevicesContent}>
          <div>
            <div className={styles.onBoardingDevicesTVRoot}>
              <h3 className={styles.h3}>На телевизоре</h3>
              <div className={styles.onBoardingDevicesGrid}>
                ...
                >
                  ...
                  <div className={styles.devicesGridDisclaimer}>
                    ...
                    превратит телевизор в Смарт ТВ
                  </div>
                </Link>
                <Link
      ...
      <div className={styles.devicesMobileRoot}>
        <div className={styles.devicesMobileLeft}>
          <h3 className={styles.h3}>На смартфоне и планшете</h3>
          <p className={styles.textRoot}>
            Установите приложение Кинопоиска, чтобы смотреть фильмы и сериалы
            где угодно — <br />
            даже без интернета.
          </p>
          <div>
            <div className={styles.root}>
              ...
              <div className={styles.copyrights}>
                <p className={styles.copyrightsTextRoot}>
                  ...
                  <br /> зарегистрированными в США и иных странах и регионах.
                  <br /> App Store является знаком обслуживания Apple Inc.
                </p>
                <p className={styles.copyrightsTextRoot}>
                  Google Play и логотип Google Play являются
                  <br /> товарными знаками корпорации Google LLC.
                </p>
              </div>
            </div>
          </div>
