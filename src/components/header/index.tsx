        ...
        <div className={styles.menu}>
          ...
          >
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M2 5h20v1.8H2V5Zm0 6h20v1.8H2V11Zm20 6H2v1.8h20V17Z"
              fill="#fff"
              fillOpacity=".6"
            ></path>
          </svg>
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
            xmlnsXlink="http://www.w3.org/1999/xlink"
            className="HeaderNavigationMenu_logo__jlwXh"
            data-tid="3ccb3df6"
          >
            <path
              fillRule="evenodd"
          ...
          <div className={styles.dropdown}>
            ...
            <div className={styles.dropdownLinks}>
              ...
              >
                <img
                  src={
                    "https://avatars.mds.yandex.net/get-bunker/60661/19bb5cee89e9e8731400087ca81ef67f761a19b0/svg"
                  }
                  alt=""
                />
                Главная
              ...
              >
                <img
                  src={
                    "https://avatars.mds.yandex.net/get-bunker/994123/21ebbf10ea4896695aeaf41d0cda6ba14309adb1/svg"
                  }
                  alt=""
                />
              ...
              >
                <img
                  src={
                    "https://avatars.mds.yandex.net/get-bunker/61205/4ca247c9044155261d3d6fd60008c3e7a9ed5bc5/svg"
                  }
                  alt=""
                />
                Фильмы
              ...
              >
                <img
                  src={
                    "https://avatars.mds.yandex.net/get-bunker/61205/f6cc158f1e16640d3fbaffbf9740a56d8be70c77/svg"
                  }
                  alt=""
                />
                Сериалы
              ...
              >
                <img
                  src={
                    "https://avatars.mds.yandex.net/get-bunker/135516/99bddd81b738dd13bfbfc582668f824c38348de3/svg"
                  }
                  alt=""
                />
                Билеты в кино
              ...
              >
                <img
                  src={
                    "https://avatars.mds.yandex.net/get-bunker/60661/1eced481dc70ee4316900cf5de0ed1a9c7dd666e/svg"
                  }
                  alt=""
                />
                Медиа
          ...
          >
            ...
            >
              <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M16.6 10.5a6.1 6.1 0 1 1-12.2 0 6.1 6.1 0 0 1 12.2 0Zm-.998 6.8a8.5 8.5 0 1 1 1.697-1.697l5.55 5.548-1.698 1.698-5.549-5.55Z"
                fill="#fff"
              ></path>
            </svg>
          </Link>
