        ...
        <div className={styles.footerContent}>
          <div className={styles.footerSocialNetworks}>
            ...
            <Link to="/">
              ...
              >
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
                  d="m21.094 3.634-3.199 16.523s-.447 1.146-1.677.596l-4.551-3.575-2.92 2.727s-.227.177-.477.066l.559-5.066.019.016.012-.103s8.186-7.54 8.521-7.86c.336-.321.224-.39.224-.39.022-.39-.604 0-.604 0L6.154 13.626l-4.519-1.558s-.693-.252-.76-.802c-.067-.55.783-.848.783-.848l17.96-7.22s1.476-.664 1.476.436Z"
                  fill="#636363"
                ></path>
              </svg>
            </Link>
            <Link to="/">
              ...
              >
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
                  d="M21.654 7.252c-.244-1.068-1.114-1.856-2.162-1.974-2.48-.278-4.99-.28-7.489-.278-2.499-.001-5.01 0-7.49.278-1.046.118-1.916.906-2.16 1.974C2.002 8.773 2 10.434 2 12c0 1.566 0 3.227.348 4.748.245 1.068 1.115 1.856 2.162 1.974C6.99 19 9.5 19.002 12 19c2.499.001 5.009 0 7.488-.278 1.047-.118 1.917-.906 2.162-1.974C22 15.226 22 13.566 22 12c0-1.566.003-3.227-.346-4.748ZM10 15.267V8.733l6 3.277-6 3.257Z"
                  fill="#636363"
                ></path>
              </svg>
            </Link>
            ...
            <Link to="/">
              ...
              >
                <path
                  d="M20.402 10.283a4.805 4.805 0 0 1-4.463-2.15v7.398a5.469 5.469 0 1 1-5.47-5.468c.115 0 .226.01.338.017v2.695c-.112-.014-.222-.034-.338-.034a2.791 2.791 0 1 0 0 5.582c1.542 0 2.904-1.215 2.904-2.756L13.4 3h2.578a4.803 4.803 0 0 0 4.427 4.287v2.996"
                  fill="#636363"
                ></path>
              </svg>
            </Link>
          ...
          <div className={styles.footerCopyrights}>
            <div className={styles.footerCopyrightsLeft}>
              ...
              <div className={styles.footerCopyrightsRow}>
                <span className={styles.textRoot}>
                  ООО «Кинопоиск», адрес местонахождения: 115035, Россия, г.
                  Москва, ул. Садовническая, д. 82, стр. 2, пом. 9А01
                </span>
              </div>
              <div className={styles.footerCopyrightsRow}>
                <span className={styles.textRoot}>
